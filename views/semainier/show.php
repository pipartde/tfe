...
<fieldset class="child">
    ...
    <p>Première heure : <?php echo $semaine['marcredi'][0]->prenom." ".$semaine['mercredi'][0]->nom ?></p>
    <p>Deuxième heure : <?php echo $semaine['marcredi'][0]->prenom." ".$semaine['mercredi'][0]->nom ?></p>
    <p>Troisième heure : <?php echo $semaine['marcredi'][1]->prenom." ".$semaine['mercredi'][1]->nom ?></p>
    <p>Quatrième heure : <?php echo $semaine['marcredi'][1]->prenom." ".$semaine['mercredi'][1]->nom ?></p>
</fieldset>
<fieldset class="child">
...
<fieldset class="child">
    ...
    <fieldset class="child">
        ...
        <form action="/semainier/delete/<?= $semainier->pk ?>" method="post">
            ...
            <input type="submit" value="supprimer ce semainier ?" onclick="return confirm('Êtes vous sûr(e) ?')">
        </form>
    </fieldset>
</div>
