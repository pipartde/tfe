<div class="container">
    ...
    <div class="title">Ajout d'un planning pour l'enfant : <?= $enfant->nom ?></div>
    ...
    <form method="post" action="/planning/store" class="create-form-planning">
        ...
        <input class="linkButton" type="submit" value="ajouter" name="addplanning" onclick="return confirm('Êtes vous sûr(e) ?')">
    </form>
